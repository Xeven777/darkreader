...
export function ActivationTab(props: ViewProps): Malevic.Child {
    ...
    if (!props.data.uiHighlights.includes('anniversary')) {
        return (
            ...
            >
                <div class="activation__success-message">Activation was successful</div>
                <ControlGroup>
    ...
    return (
        ...
        >
            ...
            <ControlGroup>
                ...
                <ControlGroup.Description>Email</ControlGroup.Description>
            </ControlGroup>
            <ControlGroup>
                ...
                <ControlGroup.Description>Code</ControlGroup.Description>
            </ControlGroup>
            <ControlGroup>
            ...
            Activate
                ...
                <ControlGroup.Description>Activate the code</ControlGroup.Description>
            </ControlGroup>
            <ControlGroup>
                <ControlGroup.Control>
                    <div class="activation__error">{store.errorMessage}</div>
                </ControlGroup.Control>
            </ControlGroup>
        </div>
    );
